...
#             #                               weight_decay=0.1)
#         else:
#             optimizer = torch.optim.AdamW(trainable_modules, lr=self.learning_rate, weight_decay=0.99)
#         return optimizer
...
class LightningModelForTrain(pl.LightningModule):
    ...
    def add_temporal_with_trained_spatial_lora_to_model(self, model, lora_rank=4, lora_alpha=4, lora_target_modules="q,k,v,o,ffn.0,ffn.2",
                          init_lora_weights="kaiming",
                          pretrained_spatial_lora_path=None, state_dict_converter=None):
        # Add LoRA to UNet
        self.lora_alpha = lora_alpha
    ...
    def configure_optimizers(self):
        ...
        if self.train_temporal_lora:
            ...
            optimizer = torch.optim.AdamW(trainable_modules, lr=self.learning_rate,weight_decay=0.001)
        return optimizer
